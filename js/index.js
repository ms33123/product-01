window.addEventListener("load", function() {
    ...
    function time() {
        ...
        var s = dt.getSeconds();
        showTime.innerHTML = year + '年' + m + '月' + d + '日' + h + '时' + min + '分' + s + '秒';
    }
    ...
    (function() {
        ...
        var option = {
            ...
            series: [{
                ...
                type: 'bar',
                barWidth: '35%',
                data: [200, 100, 300, 900, 1500, 1200, 600],
                itemStyle: {
                    barBorderRadius: 5
                }
            }]
    ...
    //模拟地图
    (function() {
        var myCharts = echarts.init(document.querySelector('.mapchart'));
        var geoCoordMap = {
            上海: [121.4648, 31.2891],
            东莞: [113.8953, 22.901],
            东营: [118.7073, 37.5513],
